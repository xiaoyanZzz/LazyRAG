#!/usr/bin/env python3
"""Self-check a generated LazyMind diagram HTML file, with no third-party deps.
...
markup is present — the structural motion contract. Animated files must also
pass the bundled `verify-motion.py`; static files use this check plus the
applicable geometry and type validators.
"""
